        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardHeaderText}>基础资料</Text>
          ...
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardHeaderText}>身体信息</Text>
              <Text style={styles.badge}>Body</Text>
            </View>
            <DisplayField
              label="身高 cm"
              value={profile.data ? `${profile.data.height_cm}` : "--"}
            />
            ...
            <Pressable
              ...
              onPress={saveBodyMetric}
              style={styles.secondaryButton}
            >
              <Text style={styles.secondaryButtonText}>
                {mutation.isPending ? "记录中" : "记录今日体重"}
              </Text>
            </Pressable>
          </View>
          ...
          <View style={styles.heroCard}>
            <View style={styles.cardHeader}>
              <Text style={styles.darkHeaderText}>算法结果</Text>
              <Text style={styles.darkBadge}>{latestMetric.data?.body_fat_formula ?? "Body"}</Text>
            </View>
          ...
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardHeaderText}>软件设置</Text>
